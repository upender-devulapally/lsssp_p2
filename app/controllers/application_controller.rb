class ApplicationController < ActionController::Base
  ...
  def exam_result(student_exam)
    if student_exam.complete_status? and  student_exam.percentage == 0
       "<span class='fail'>Fail</span>".html_safe
    elsif student_exam.percentage == 0
       "<span class='exam_result_pending'>Pending</span>".html_safe
    elsif student_exam.percentage >= student_exam.examination.pass_marks_percentage
